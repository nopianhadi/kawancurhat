...
const testimonials = [
  {
    id: 'asg',
    quote: 'Penanganan terhadap anak perusahaan ASG di tower ASG. Penanganan yang responsif dan sangat baik.',
    name: 'Gedung ASG',
    company: '',
  ...
  {
    id: 'kh-yusuf-mansur',
    quote: 'Profesional dalam menangani kasus, muda, cerdas dan berpengalaman.',
    name: 'KH Yusuf Mansur',
    company: 'Tokoh Nasional dan Pengusaha',
    imgSrc: '/aset/Folder Baru/KH Yusuf Mansur.jpg',
    rating: 5
  },
  {
    id: 'colas-rail',
    quote: 'Pendampingan hukum yang luar biasa. Membantu kami menghindari resiko hukum.',
    name: 'Colas Rail',
    company: 'Perusahaan Infrastruktur',
    imgSrc: '/aset/FQGwjWxFujEGoR5UIhNoCDGNls.jpg',
    rating: 5
  },
  {
    id: 'mr.-wira',
    quote: 'Layanan Litigasi yang Profesional. Mereka menemukan celah-celah yang bisa merugikan bisnis kami. Terima kasih atas perlindungannya!',
    name: 'Mr. Wira',
    company: 'PT. Wira Papper',
    imgSrc: '/aset/testimon3.jpg',
    rating: 5
  },
  {
    id: 'ibu-suryati',
    ...
    name: 'Ibu Suryati',
    company: 'Pengusaha Jasa Ekspedisi',
    imgSrc: '/aset/testimoni1.png',
    rating: 5
  },
  {
    id: 'mr.-ujang',
    quote: 'Pendekatan yang komunikatif dan solutif membuat kami merasa nyaman, benar-benar mitra bisnis yang terpercaya.',
    name: 'Mr. Ujang',
    company: 'PT Shanfu',
    imgSrc: '/aset/testimoni2.jpg',
    rating: 5
  }
];
