        ...
        >
          ...
          <div className="columns-2 md:columns-3 lg:columns-4 gap-3 sm:gap-4 md:gap-6 space-y-3 sm:space-y-4 md:space-y-6">
            ...
            <div className="relative overflow-hidden rounded-xl md:rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 group break-inside-avoid mb-3 sm:mb-4 md:mb-6">
              <img 
                src="/aset/Folder Baru/GALERY/ASG.jpg" 
                alt="Galeri ASG" 
            ...
            <div className="relative overflow-hidden rounded-xl md:rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 group break-inside-avoid mb-3 sm:mb-4 md:mb-6">
              <img 
                src="/aset/Folder Baru/GALERY/Gambar WhatsApp 2025-11-21 pukul 13.04.53_9bb8993b.jpg" 
                alt="Galeri 2" 
                className="w-full h-auto object-cover group-hover:scale-110 transition-transform duration-700"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
            ...
            <div className="relative overflow-hidden rounded-xl md:rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 group break-inside-avoid mb-3 sm:mb-4 md:mb-6">
              <img 
                src="/aset/Folder Baru/GALERY/Gambar WhatsApp 2025-11-21 pukul 13.07.19_38d88533.jpg" 
                alt="Galeri 3" 
                className="w-full h-auto object-cover group-hover:scale-110 transition-transform duration-700"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
            ...
            <div className="relative overflow-hidden rounded-xl md:rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 group break-inside-avoid mb-3 sm:mb-4 md:mb-6">
              <img 
                src="/aset/Folder Baru/GALERY/Gambar WhatsApp 2025-11-21 pukul 13.09.30_78b09449.jpg" 
                alt="Galeri 4" 
                className="w-full h-auto object-cover group-hover:scale-110 transition-transform duration-700"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
            ...
            <div className="relative overflow-hidden rounded-xl md:rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 group break-inside-avoid mb-3 sm:mb-4 md:mb-6">
              <img 
                src="/aset/Folder Baru/GALERY/Gambar WhatsApp 2025-11-21 pukul 13.09.30_b8e35de5.jpg" 
                alt="Galeri 5" 
                className="w-full h-auto object-cover group-hover:scale-110 transition-transform duration-700"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
            ...
            {/* Image 6 - KH Yusuf Mansur */}
            <div className="relative overflow-hidden rounded-xl md:rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 group break-inside-avoid mb-3 sm:mb-4 md:mb-6">
              <img 
                src="/aset/Folder Baru/GALERY/KH Yusuf Mansur.jpg" 
                alt="KH Yusuf Mansur" 
                className="w-full h-auto object-cover group-hover:scale-110 transition-transform duration-700"
              />
            ...
            {showMore && (
              <>
                ...
                <div className="relative overflow-hidden rounded-xl md:rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 group break-inside-avoid mb-3 sm:mb-4 md:mb-6">
                  <img 
                    src="/aset/Folder Baru/GALERY/Gambar WhatsApp 2025-11-24 pukul 12.18.20_01e63665.jpg" 
                    alt="Galeri 7" 
                    className="w-full h-auto object-cover group-hover:scale-110 transition-transform duration-700"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                ...
                <div className="relative overflow-hidden rounded-xl md:rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 group break-inside-avoid mb-3 sm:mb-4 md:mb-6">
                  <img 
                    src="/aset/Folder Baru/GALERY/Gambar WhatsApp 2025-11-24 pukul 12.22.04_acc3b090.jpg" 
                    alt="Galeri 8" 
                    className="w-full h-auto object-cover group-hover:scale-110 transition-transform duration-700"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                ...
                <div className="relative overflow-hidden rounded-xl md:rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 group break-inside-avoid mb-3 sm:mb-4 md:mb-6">
                  <img 
                    src="/aset/Folder Baru/GALERY/VENA-29.jpg" 
                    alt="Galeri 9" 
                    className="w-full h-auto object-cover group-hover:scale-110 transition-transform duration-700"
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
                ...
                <div className="relative overflow-hidden rounded-xl md:rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 group break-inside-avoid mb-3 sm:mb-4 md:mb-6">
                  ...
                  >
                    <source src="/aset/Folder Baru/GALERY/Video WhatsApp 2025-11-24 pukul 12.22.14_5784c61c.mp4" type="video/mp4" />
                ...
                <div className="relative overflow-hidden rounded-xl md:rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-500 group break-inside-avoid mb-3 sm:mb-4 md:mb-6">
                  <video 
                    ...
                    className="w-full h-auto object-cover"
                  >
                    <source src="/aset/Folder Baru/GALERY/Video WhatsApp 2025-11-24 pukul 12.22.28_cbdf5059.mp4" type="video/mp4" />
                    Browser Anda tidak mendukung video.
                  </video>
                  <div className="absolute top-2 right-2 bg-black/70 text-white px-2 py-1 rounded-full text-xs font-semibold">
                    Video
