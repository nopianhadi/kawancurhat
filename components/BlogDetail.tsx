...
const blogPostsData: BlogPost[] = [
  {
    ...
    imgSrc: '/aset/Folder Baru/BLOG/VENA-1.jpg',
    author: 'Aship Firmansyah, S.E., S.H.',
  ...
  },
  {
    ...
    imgSrc: '/aset/Folder Baru/BLOG/VENA-3.jpg',
    author: 'Aship Firmansyah, S.E., S.H.',
        ...
        <div className="grid lg:grid-cols-3 gap-3 sm:gap-4 md:gap-6 lg:gap-8">
          ...
          <div className="space-y-3 sm:space-y-4 md:space-y-6">
            ...
            <div className="bg-white rounded-lg sm:rounded-xl shadow-lg p-3 sm:p-4 md:p-6">
              ...
              <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-3">
                ...
                <div>
                  ...
                  <p className="text-[10px] sm:text-xs md:text-sm text-gray-500">Konsultan Hukum Bisnis dan Pengacara</p>
                </div>
              </div>
            ...
            <div className="bg-brand-accent text-white rounded-lg sm:rounded-xl shadow-lg p-3 sm:p-4 md:p-6">
              ...
              <a 
                href="mailto:email@kawancurhat.com"
