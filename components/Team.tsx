...
const teamMembers = [
  {
    ...
    imgSrc: '/aset/Folder Baru/PROFIL/VENA-9.jpg',
    photos: [
      '/aset/Folder Baru/PROFIL/VENA-9.jpg',
      '/aset/Folder Baru/PROFIL/VENA-10.jpg',
      '/aset/Folder Baru/PROFIL/VENA-30.jpg',
      '/aset/Folder Baru/PROFIL/VENA-33.jpg'
    ],
    socials: { 
...
const TeamMemberCard: React.FC<{ member: typeof teamMembers[0]; index: number }> = ({ member, index }) => {
    ...
    return (
        ...
        >
            <div className="relative overflow-hidden rounded-xl sm:rounded-2xl shadow-lg mb-2 sm:mb-3 md:mb-4 transition-all duration-300 group-hover:shadow-2xl group-hover:scale-105 max-w-xs sm:max-w-md md:max-w-lg mx-auto" style={{ aspectRatio: '3/4' }}>
            ...
            <div className="mt-4 sm:mt-6 space-y-2 sm:space-y-3 px-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3">
                ...
                <a 
                  href="/aset/Folder Baru/klien.jpg"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 px-3 py-2 sm:px-4 sm:py-2.5 bg-gradient-card border border-gray-200 rounded-lg hover:border-brand-accent hover:shadow-md transition-all duration-300 group"
                >
                  ...
                  <span className="text-xs sm:text-sm font-medium text-gray-700 group-hover:text-brand-accent">Klien Kami</span>
                </a>

                <a 
                  href="/aset/kartu tanda pengenal.jpg
                  "
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 px-3 py-2 sm:px-4 sm:py-2.5 bg-gradient-card border border-gray-200 rounded-lg hover:border-brand-accent hover:shadow-md transition-all duration-300 group"
                >
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 text-brand-accent group-hover:scale-110 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 2L3 14h4l-2 8 7-12h-4l3-8z"/>
                  </svg>
                  <span className="text-xs sm:text-sm font-medium text-gray-700 group-hover:text-brand-accent">Kartu Tanda Pengenal</span>
                </a>
              </div>
            </div>
        </div>
